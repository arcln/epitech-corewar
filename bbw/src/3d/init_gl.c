/*
** init_g_gl.c for corewar in /home/onehandedpenguin/Dev/CPE_2016/CPE_2016_corewar/bbw/src/3d/
**
** Made by Paul Laffitte
** Login   <paul.laffitte@epitech.eu>
**
** Started on  Sun Mar 26 21:51:56 2017 Paul Laffitte
** Last update Tue Apr 25 11:11:28 2017 Arthur Chaloin
*/
...
int			init_gl(GtkGLArea *gl_area)
{
  ...
  g_gl.shader = load_shaders("src/3d/shaders/simple.vert",
			   "src/3d/shaders/simple.frag");
